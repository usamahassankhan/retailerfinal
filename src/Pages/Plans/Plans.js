...
export default function EnhancedTable() {
  ...
  const getplans = () => {
    db.collection("planSummary")
      .where("id", "==", localStorage.getItem("myid"))
      // .orderBy("date")
      // .limit(10)
      .get()
      .then((querySnapshot) => {
        ...
        querySnapshot.forEach(function (doc) {
          ...
          console.log("dsas", doc.data());
          console.log(Matches, "dasdssa");
  ...
  const rows = tabledata.map((a) =>
    createData(
      a.team1.plantemplateid,
      a.team1.banner,
      a.team1.plantemplatename,
      a.team1.storenumber,
      a.team1.storeaddressline1 + a.team1.storeaddressline2,
      a.team1.planstartdate,
      a.team1.planenddate,
      a.team1.spendrange,
      a.team1.cashbackrange,
      a.team1.maxcustomer,
      "approved"
    )
  );
  ...
  return (
    <div className={classes.root} className="wao">
      ...
      <div className="templatelast">
        ...
        <button onClick={() => history.push("planform")}>
          Create New Plan{" "}
        </button>
      </div>
      <Modal className={classes.modal} open={open} onClose={handleClose}>
        <div className={classes.paper1}>
          ...
          <div style={{ display: "flex", justifyContent: "space-evenly" }}>
            <button className="modalbtn" onClick={deleteplan}>
              Yes
            </button>
